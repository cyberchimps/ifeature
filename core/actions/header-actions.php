...
function synapse_nav() {
	...
	<div class="container">
		<div class="row">
			...
			<?php if ($options->get($themeslug.'_hide_home_icon') != "0"):?><div id="home"><a href="<?php esc_attr_e( $url ); ?>"><img src="<?php echo $template_dir; ?>/images/home.png" alt="home" /></a></div><?php endif;?>
