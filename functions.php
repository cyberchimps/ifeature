...
add_action('admin_init','removee_upgrade_bar');
function removee_upgrade_bar(){
...
function ifeature_ribbon_styles() {
...
add_action( 'wp_enqueue_scripts', 'ifeature_ribbon_styles', 30 );
