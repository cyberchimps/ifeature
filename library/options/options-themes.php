...
<div id="contain">
	<div id="themesheader">
		<a href="<?php esc_url( 'http://cyberchimps.com' ); ?>" target="_blank"><img src="<?php echo $root ;?>/images/themes/cyberchimps.png" /></a>
		<br />
	...
	<div class="theme_images">
		<a href="<?php esc_url( 'http://cyberchimps.com/ifeaturepro/' ); ?>" target="_blank"><img src="<?php echo $root ;?>/images/themes/ifeaturepro2.png" /></a>
	</div>
	<div class="theme_desciptions">
		<div class="theme_titles"><a href="<?php esc_url( 'http://cyberchimps.com/ifeaturepro/' ); ?>" target="_blank"><?php printf( __( 'iFeature Pro', 'ifeature' )); ?></a></div>
		<br />
		...
		<div class="buy"><a href="<?php esc_url ( 'http://cyberchimps.com/ifeaturepro/ '); ?>" target="_blank"><?php printf( __( 'Buy iFeature Pro', 'ifeature' )); ?></a></div>
	</div>
	
		<div class="theme_images">
		<a href="<?php esc_url( 'http://cyberchimps.com/droidpresspro/' ); ?>" target="_blank"><img src="<?php echo $root ;?>/images/themes/droidpresspro.png" /></a>
	</div>
	<div class="theme_desciptions">
		<div class="theme_titles"><a href="<?php esc_url( 'http://cyberchimps.com/droidpresspro/' ); ?>" target="_blank"><?php printf( __( 'DroidPress Pro', 'ifeature' )); ?></a></div>
		<br />
		...
		<div class="buy"><a href="<?php esc_url( 'http://cyberchimps.com/droidpresspro/', 'ifeature' ); ?>" target="_blank"><?php printf( __( 'Buy DroidPress Pro', 'ifeature' )); ?></a></div>
	</div><br />
	
	<div class="theme_images">
		<a href="<?php esc_url( 'http://cyberchimps.com/businesspro/' ); ?>" target="_blank"><img src="<?php echo $root ;?>/images/themes/bizpro.png" /></a>
	</div>
	<div class="theme_desciptions">
		<div class="theme_titles"><a href="<?php esc_url( 'http://cyberchimps.com/businesspro/' ); ?>" target="_blank"><?php printf( __( 'Business Pro', 'ifeature' )); ?></a></div>
		<br />
		...
		<br /><br />
		<div class="buy"><a href="<?php esc_url( 'http://cyberchimps.com/businesspro/' ); ?>" target="_blank"><?php printf( __( 'Buy Business Pro', 'ifeature' )); ?></a></div>
	</div>
		
	<div class="theme_images">
		<a href="<?php esc_url( 'http://cyberchimps.com/neuropro/' ); ?>" target="_blank"><img src="<?php echo $root ;?>/images/themes/neuropro.png" /></a>
	</div>
	<div class="theme_desciptions">
		<div class="theme_titles"><a href="<?php esc_url( 'http://cyberchimps.com/neuropro/' ); ?>" target="_blank"><?php printf( __( 'Neuro Pro', 'ifeature' )); ?></a></div>
		<br />
		...
		<br /> <br />
		<div class="buy"><a href="<?php esc_url( 'http://cyberchimps.com/neuropro/' ); ?>" target="_blank"><?php printf( __( 'Buy Neuro Pro', 'ifeature' )); ?></a></div>
	</div>
